...
public class OpLogController {
    ...
    @Transactional
    public APIResponse clearLoginLog() throws IOException {
        service.clearLoginLog();
        return new APIResponse(ResponeCode.SUCCESS, "成功");
    }



    @RequestMapping(value = "/clearOpLog", method = RequestMethod.POST)
    @Transactional
    public APIResponse clearOpLog() throws IOException {
        service.clearOpLog();
        return new APIResponse(ResponeCode.SUCCESS, "成功");
    }
